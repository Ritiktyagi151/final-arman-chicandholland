        ...
        <div className="flex items-center  gap-6 pb-2 4xl:pb-5">
          ...
          <NavigationMenu className="hidden  lg:flex">
            <NavigationMenuList>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink href="/contact-us" className={`${navigationMenuTriggerStyle()} font-brandon`}>
                  CONTACT US
                </NavigationMenuLink>
              </NavigationMenuItem>

              <NavigationMenuItem>
                <NavigationMenuLink href="/find-a-store" className={`${navigationMenuTriggerStyle()} font-brandon`}>
                  FIND A STORE
                </NavigationMenuLink>
              </NavigationMenuItem>

              <NavigationMenuItem>
                <NavigationMenuLink href="/size-chart" className={`${navigationMenuTriggerStyle()} font-brandon`}>
                  SIZE CHART
                </NavigationMenuLink>
              </NavigationMenuItem>
              ...
              {!isLoggedIn && (
                <NavigationMenuItem>
                  <NavigationMenuLink href="/become-a-retailer" className={`${navigationMenuTriggerStyle()} font-brandon`}>
                    BECOME A RETAILER
                  </NavigationMenuLink>
                </NavigationMenuItem>
              )}
