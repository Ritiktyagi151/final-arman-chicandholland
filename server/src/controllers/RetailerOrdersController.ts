...
// 📌 Get Order Detail by ID (Used by QR Scan)
// router.get(
//   "/:id",
//   asyncHandler(async (req: Request, res: Response) => {
//     const { id } = req.params;
...
// router.get(
//   "/report/stock-status/report/:id",
//   asyncHandler(async (req: Request, res: Response) => {
//     const { id } = req.params;

//     try {
//       // 1️⃣ Fetch Main Retailer Order
//       const order = await RetailerOrder.findOne({
//         where: { id: Number(id), is_stock_order: true },
//         relations: ["Stock_order"],
//       });

//       if (!order) {
//         return res.json({
//           success: false,
//           message: "Not a stock order",
//         });
//       }

//       // 2️⃣ Fetch STOCK ORDER styles with barcode
//       const stockStyles = await StockOrderStyles.find({
//         where: { retailerOrder: { id: order.id } },
//         order: { id: "ASC" },
//       });
...
//         let totalQty = 1; // stock always 1 quantity
//         let completedQty = logs.reduce(
